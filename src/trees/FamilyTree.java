...
public class FamilyTree
{
	...
	private void addLine(String line) throws TreeException
    {
        ...
        if (colonIndex < 0) {
            throw new TreeException("Colon can not be found");
        }
        String parent = line.substring(0, colonIndex-1);
        ...
        else
        {
            ...
            if (parentNode.equals(null)) {
                throw new TreeException("Parent node can not be found");
            }
        }
